...
public class ChooseCityUtil
    ...
    private void setNomal() {
        ...
        //设置字体颜色
        setNumberPickerTextColor(npProvince, context.getResources().getColor(R.color.colorAccent));
        setNumberPickerTextColor(npCity, context.getResources().getColor(R.color.colorAccent));
        setNumberPickerTextColor(npCounty, context.getResources().getColor(R.color.colorAccent));
    }
                    ...
                    pf.set(picker,
                            new ColorDrawable(
                                    context.getResources().getColor(
                                            R.color.colorPrimary)));// pf.set(picker, new Div)
